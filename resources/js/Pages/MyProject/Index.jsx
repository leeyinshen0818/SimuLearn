                                                        ...
                                                        return (
                                                            <div className={`mt-6 border-t pt-6 ${isPassing ? 'border-green-100' : 'border-red-100'}`}>
                                                                <div className={`rounded-lg p-6 ${isPassing ? 'bg-green-50' : 'bg-red-50'}`}>
                                                                    ...
                                                                    <div className="prose prose-sm max-w-none prose-indigo p-4 bg-white rounded border border-gray-200 shadow-sm">
                                                                        <h5 className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Feedback</h5>
                                                                        <div
                                                                            dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(marked.parse(latestSubmission.feedback)) }}
                                                                        />
                                                                    </div>
                                        ...
                                        {activeProject.tasks && activeProject.tasks.map((task, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            <div className={`shrink-0 h-8 w-8 flex items-center justify-center rounded-full font-bold text-xs mr-4 ${isCompleted ? 'bg-green-100 text-green-800' :
